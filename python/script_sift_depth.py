# -*- coding: utf-8 -*-
"""
Created on Wed Dec  2 15:03:22 2020

@author: Wei Huajing
@company: KAMERAWERK
@e-mail: wei@kamerawerk.cn

@title：script-stereo-camera-depth-estimation
...
kp2, des2 = sift.detectAndCompute(image_left, None)

FLANN_INDEX_KDTREE = 0

flann = cv2.FlannBasedMatcher(dict(algorithm=FLANN_INDEX_KDTREE, trees=5), dict(checks=5))
